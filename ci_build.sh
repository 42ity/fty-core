...
#        $CI_TIME git clone --quiet --depth 1 https://github.com/zeromq/libzmq.git libzmq
    ...
    ; then
        ...
        $CI_TIME git clone --quiet --depth 1 -b release/IPM_Infra-1.3 https://github.com/zeromq/czmq.git czmq
        cd czmq
        CCACHE_BASEDIR=${PWD}
        export CCACHE_BASEDIR
        git --no-pager log --oneline -n1
    ...
    ; then
        ...
        $CI_TIME git clone --quiet --depth 1 -b release/IPM_Infra-1.3 https://github.com/42ity/libmagic magic
        cd magic
        CCACHE_BASEDIR=${PWD}
        export CCACHE_BASEDIR
        git --no-pager log --oneline -n1
    ...
    ; then
        ...
        $CI_TIME git clone --quiet --depth 1 -b release/IPM_Infra-1.3 https://github.com/42ity/tntdb tntdb
        cd tntdb
        cd ./tntdb
        CCACHE_BASEDIR=${PWD}
        export CCACHE_BASEDIR
