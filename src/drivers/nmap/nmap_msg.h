...
port scan results and os scan one (if enabled).
        ...
        hostnames           dictionary  dictionary of hostname : type, where type is a type of hostname (user, PTR)
        ports               msg         List of port_scan results. Each frame is nmap_msg_port_scan_t
        os                  msg         List of os_scan results. Each frame is nmap_msg_os_scan_t
        scripts             msg         List of script results. Each frame is nmap_msg_script_t
...
about service(s) running on port and result of scan scripts if any.
        ...
        service             msg         Service detected on a port (optional, nmap_msg_service_scan_t)
        scripts             msg         List of script results. Each frame is nmap_msg_script_t
    ...
    OS_SCAN - Operating system scan results (if available)
        portused            msg         List of portused results. Each frame is nmap_msg_portused_t
        osmatch             msg         List of osmatch results. Each frame is nmap_msg_osmatch_t
        osclass             msg         List of osclass results. Each frame is nmap_msg_osscan_t
