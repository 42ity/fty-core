...
static constexpr size_t _WSErrorsCOUNT = 13;
...
static constexpr const _WSErrors _errors = { {
    ...
    {.key = "not-authorized",           .http_code = HTTP_UNAUTHORIZED,             .err_code = 43,      .message = "You are not authorized or your rights are insufficient. Please use '/oauth2/token?username=<user_name>&password=<password>&grant_type=password' GET request to authorize."},
