...
log_define("component.alert_rules")

// <%pre>
#line 25 "src/web/src/alert_rules.ecpp"
...
static tnt::ComponentFactoryImpl<_component_> Factory("alert_rules");
...
{
  log_trace("alert_rules " << qparam.getUrl());

  tnt::DataChunks data(rawData);

  // <%cpp>
#line 39 "src/web/src/alert_rules.ecpp"
...
#line 133 "src/web/src/alert_rules.ecpp"
  reply.out() << ( part );
  reply.out() << data[0]; // \n
#line 134 "src/web/src/alert_rules.ecpp"
