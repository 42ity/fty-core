...
echo "***************************************************************************************************"
#*#*#*#*#*#*# TODO : Really should PASS not allowed format?
...
echo "***************************************************************************************************"
#*#*#*#*#*#*# TODO : Wrong message : MUST BE LIKE : Method is not allowed : 45
...
#*#*#*#*#*#*# TODO : Completely wrong : Alenka : ask to Michal
#curlfail_push_expect_400
initiate_db
REZ=0
...
echo "***************************************************************************************************"
test_it "Too_big_file"
#*#*#*#*#*#*# TODO : the code 48 received is not expected : 47???
curlfail_push_expect_400
initiate_db
REZ=0
...
echo "***************************************************************************************************"
test_it "Not_so_long"
#*#*#*#*#*#*# TODO : 128kB is 131072 byte : the not_so_long_asset_tab_16LE.csv has size 130860
curlfail_push_expect_413
initiate_db
REZ=0
