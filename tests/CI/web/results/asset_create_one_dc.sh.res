{"errors":[{"message":"Request document has invalid syntax. ","code":48}]}
{"errors":[{"message":"Request document has invalid syntax. Cannot import empty document.","code":48}]}
{"id":"36"}
{"errors":[{"message":"Element 'element_name' cannot be processed because of conflict. Most likely duplicate entry.","code":50}]}
...
{"errors":[{"message":"Parameter 'type' is required.","code":46}]}
...
{"errors":[{"message":"Parameter 'asset_tag' is required.","code":46}]}
