{"accepted":"no","version":"1.0"}
{"errors":[{"message":"You are not authenticated or your rights are insufficient.","code":43}]}
{"errors":[{"message":"REST API call is forbidden. Please accept license first.","code":51}]}
{"errors":[{"message":"You are not authenticated or your rights are insufficient.","code":43}]}
{"success":"License version 1.0 accepted."}
{"accepted":"yes","version":"1.0","accepted_version":"1.0","accepted_at":"XXX","accepted_by":"admin"}
{"text":"yes"}
