...
test suite resides under '${srcdir}/tests/CI/web/' in this tree.

 * create a new file under '${srcdir}/tests/CI/web/commands/'
 ...
 * save expected output in '${srcdir}/tests/CI/web/results/testname.sh.res'
  for later comparison during automated tests
