...
grep -q "\[ 9," /tmp/DC008.log || die "ERROR : 'Test of the line   9 	FAILED'"
echo "Test of the line  9 					PASSED"
grep -q "\[ 10," /tmp/DC008.log || die "ERROR : 'Test of the line 10 	FAILED'"
echo "Test of the line 10 					PASSED"
grep -q "\[ 17," /tmp/DC008.log || die "ERROR : 'Test of the line 17 	FAILED'"
echo "Test of the line 17 					PASSED"
grep -q "\[ 21," /tmp/DC008.log || die "ERROR : 'Test of the line 21 	FAILED'"
echo "Test of the line 21 					PASSED"
grep -q "\[ 22," /tmp/DC008.log || die "ERROR : 'Test of the line 22 	FAILED'"
echo "Test of the line 22 					PASSED"
grep -q "\[ 23," /tmp/DC008.log || die "ERROR : 'Test of the line 23 	FAILED'"
