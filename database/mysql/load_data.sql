...
/* RACK1-LAB */
insert into t_bios_asset_element (id_asset_element, name , id_type, id_parent, status,priority, asset_tag) values (NULL, "RACK1-LAB", @asset_element_rack, @last_room, "active",1,"myasset21");
set @last_asset_element := LAST_INSERT_ID();
...
/* UPS1-LAB */
insert into t_bios_asset_element (name , id_type, id_subtype, id_parent, status,priority,asset_tag) values ("UPS1-LAB", @asset_element_device, @asset_device_ups, @last_rack,"active",1, "myasset22");
set @last_asset_element := LAST_INSERT_ID();
...
/* UPS2-LAB */
insert into t_bios_asset_element (name , id_type, id_subtype, id_parent, status,priority,asset_tag) values ("UPS2-LAB", @asset_element_device, @asset_device_ups, @last_rack, "active",1,"myasset23");
set @last_asset_element := LAST_INSERT_ID();
...
/* ePDU1-LAB */
insert into t_bios_asset_element (name , id_type, id_subtype, id_parent, status,priority,asset_tag) values ("ePDU1-LAB", @asset_element_device, @asset_device_epdu, @last_rack, "active",1,"myasset24");
set @last_asset_element = LAST_INSERT_ID();
...
/* ePDU2-LAB */
insert into t_bios_asset_element (name , id_type, id_subtype, id_parent, status,priority,asset_tag) values ("ePDU2-LAB", @asset_element_device, @asset_device_epdu, @last_rack,"active",1, "myasset25");
set @last_asset_element = LAST_INSERT_ID();
...
/* SRV1-LAB */
insert into t_bios_asset_element (name , id_type, id_subtype, id_parent, status,priority,asset_tag) values ("SRV1-LAB",  @asset_element_device, @asset_device_server, @last_rack,"active",1, "myasset26");
set @last_asset_element = LAST_INSERT_ID();
...
/* SRV2-LAB */
insert into t_bios_asset_element (name , id_type, id_subtype, id_parent, status,priority,asset_tag) values ("SRV2-LAB", @asset_element_device, @asset_device_server, @last_rack, "active",1,"myasset27");
set @last_asset_element = LAST_INSERT_ID();
...
/* SRV3-LAB */
insert into t_bios_asset_element (name , id_type, id_subtype, id_parent, status,priority,asset_tag) values ("SRV3-LAB",  @asset_element_device, @asset_device_server, @last_rack, "active",1,"myasset50");
set @last_asset_element = LAST_INSERT_ID();
...
/* SRV4-LAB */
insert into t_bios_asset_element (name , id_type, id_subtype, id_parent, status,priority,asset_tag) values ("SRV4-LAB", @asset_element_device, @asset_device_server, @last_rack, "active",1,"myasset31");
set @last_asset_element = LAST_INSERT_ID();
...
/* SRV5-LAB */
insert into t_bios_asset_element (name , id_type, id_subtype, id_parent, status,priority,asset_tag) values ("SRV5-LAB",  @asset_element_device, @asset_device_server, @last_rack, "active",1,"myasset32");
set @last_asset_element = LAST_INSERT_ID();
...
/* SRV6-LAB */
insert into t_bios_asset_element (name , id_type, id_subtype, id_parent, status,priority,asset_tag) values ("SRV6-LAB", @asset_element_device, @asset_device_server, @last_rack, "active",1,"myasset33");
set @last_asset_element = LAST_INSERT_ID();
