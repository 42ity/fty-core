/* Add "power-meter" asset subtype */
/* For details on schema version support see the main initdb.sql */
SET @bios_db_schema_version = '201907010001' ;
SET @bios_db_schema_filename = '0017_device_type_extension.sql' ;
...
INSERT INTO t_bios_asset_device_type (id_asset_device_type, name) VALUES (20, "power-meter");
