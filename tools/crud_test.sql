...
/* for aupdate element*/
INSERT INTO t_bios_asset_element (id_asset_element, name, id_type, id_parent, business_crit, status, priority) VALUES (6, "asset_crud_DEVICE_update",6, 1, 0, "nonactive", 3);
