...
#ifndef bios_library_H_INCLUDED
#define bios_library_H_INCLUDED
...
#   if defined LIBBIOS_STATIC
#       define BIOS_EXPORT
#   elif defined LIBBIOS_EXPORTS
#       define BIOS_EXPORT __declspec(dllexport)
#   else
#       define BIOS_EXPORT __declspec(dllimport)
#   endif
#else
#   define BIOS_EXPORT
#endif
